...
(function () {
    ...
    define('build/handle/HandleRect', [
        'dou',
        'KineticJS'
    ], function (dou, kin) {
        'use strict';
...
(function () {
    define('build/spec/SpecPainter', [
        ...
        '../handle/HandleRect'
    ], function (kin, SpecInfographic, SpecContentEditLayer, SpecGuideLayer, SpecRulerLayer, SpecHandleLayer, SpecMinimapLayer, SpecGroup, SpecRect, SpecCircle, SpecRing, SpecRuler, SpecImage, SpecText, SpecStar, SpecBarcode, HandleChecker, HandleRect) {
        'use strict';
        var createView;
        createView = function (attributes) {
